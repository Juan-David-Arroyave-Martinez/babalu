...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '74.220.215.53', 'port' => '', 'dbname' => 'makemark_bbl_pres', 'user' => 'makemark_Bbl_Prs', 'password' => 'makemark_Bbl_Prs123', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a71af5f8623760aaf724b288be06f5a56f8667662a28366987ff8d37bc71b642');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2eZ6FMxeZnLk4I3joidky2F6yRaBXy8LXxIjruNr6tdQDkiEZExs1EgJ');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '74.220.215.53',
            'database_port' => '',
            'database_name' => 'makemark_bbl_pres',
            'database_user' => 'makemark_Bbl_Prs',
            'database_password' => 'makemark_Bbl_Prs123',
            'database_prefix' => 'ps_',
            ...
            'secret' => '2eZ6FMxeZnLk4I3joidky2F6yRaBXy8LXxIjruNr6tdQDkiEZExs1EgJ',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-11-14',
            'locale' => 'es-ES',
            'cookie_key' => 'NoW14g8UqgOTWScxCnsp26GeiEamCQvju3tGdLo18FvFjcQ9KmoJ6RYZ',
            'cookie_iv' => 'TD7CG5eJ',
            'new_cookie_key' => 'def00000cd939ef8b6452ca776cc271eecbbeb98ae33e035078e8440d2db8cb5114fc764673ccdc4bc723610576e6482c6812057af48ba303d963ac81dee36edb57d7afd',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '2eZ6FMxeZnLk4I3joidky2F6yRaBXy8LXxIjruNr6tdQDkiEZExs1EgJ',
