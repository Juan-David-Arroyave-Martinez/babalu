                    ...
                    {else}
                        <div id="promotions_0" class="promotion_item">
                            <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                ...
                                <textarea class="rte_promotion rte_promotion_0" name="promotions[0][description]"></textarea>

                                <label>Url</label>
                                <input type="text" name="promotions[0][url]" class="url_promotion" value="">

                                <label>Image</label>
                                <input type="text" name="promotions[0][image]" class="image_promotion" value="">
                            </div>
                            <br><br>
                        </div>
                    {/if}
